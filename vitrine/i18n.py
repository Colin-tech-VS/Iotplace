...
def compte_js_i18n() -> dict:
    return {
        ...
        "messenger": {
            ...
            "startup_stripe_hint": t("compte.dashboard.messenger.startup_stripe_hint"),
            "escrow_title": t("compte.dashboard.messenger.escrow_title"),
            "mission_amount": t("compte.dashboard.messenger.mission_amount"),
            "pay_invoice": t("compte.dashboard.messenger.pay_invoice"),
            "release_funds": t("compte.dashboard.messenger.release_funds"),
            "retry_invoice": t("compte.dashboard.messenger.retry_invoice"),
            "configure_stripe": t("compte.dashboard.messenger.configure_stripe"),
